...
function Chatting2({navigation}) {
  return (
    <>
      <Appbar.Header>
        <Appbar.BackAction onPress={() => navigation.goBack('') } />
        <Appbar.Content title="Mama" subtitle="Online" />
      ...
      source={require('./bgwa.jpeg')}>
        ...
        <Text style={styles.container2}>cari aja tutorial atur kamera render</Text>
        <Text style={styles.container}>agak susah jelasinnya gw</Text>
        <Text style={styles.container2}>oh oke zul</Text>
        </ImageBackground>
